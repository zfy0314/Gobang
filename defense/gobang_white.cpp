...
#include<stack>
using namespace std;
char qp[19][19];//���̣�0��1����2���
//char qz[2][180][8];//�Է��������ߵķ��� 
//char qzx[2][180],qzy[2][180];//����������� 
...
char pd(char x,char y,char a)//a:�ڼ��� b:�ڰ� c:����  ���أ�0�� 1���� 2��� 3������ 
{
  //x1=qp[x][y];
  //y1=qp[x][y];
  switch(a)
...
void lxpd(char x,char y,char a)//���� 
{
  //k=0;
  switch(a)
  {
